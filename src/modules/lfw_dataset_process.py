...
RECONSTRUCTED_DIR = "../../data/anonymized_output"
...
def main():
    ...
    pipeline_result = anony_process_pipeline.run_pipeline(df_images=df, epsilon=0.5, n_components_ratio=0.7, k_same_k_value=3)
    print("Traitement terminé. Les images reconstruites ont été enregistrées dans le dossier 'anonymized_output'.")
